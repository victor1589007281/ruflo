...
| 03 | [时序图详解](./03-sequence-diagrams.md) | 9 张完整时序图：MCP 调用、提示词注入、LLM 钩子、Swarm 编排、治理门控、SONA 学习、MCP 路由、模型路由、**端到端全流程** | **Mermaid 时序图** |
...
| 06 | [MCP 工具完整清单](./06-mcp-tools.md) | MCP 协议实现、260+ 工具按模块分类、完整参数列表、工具统计 | **MCP 接口全景** |
| 07 | [编排系统详解](./07-orchestration.md) | 5 种拓扑模式、任务分配算法、共识算法、消息总线、Agent 池、Federation、场景推荐 | **编排架构** |
| 08 | [Go 语言复刻方案](./08-golang-rewrite-plan.md) | 目录设计、模块映射、关键代码示例、甘特图开发计划、性能目标、风险评估 | **Go 实现方案** |
