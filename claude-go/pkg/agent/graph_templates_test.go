...
// 要么有等价模板 (灰度可切, 内核仍是 stageNodeRunner), 要么有专属节点内核
// (orchestrated 无条件跑图引擎; ensemble_extract/review_panel 灰度可切, 判据在各自
// 执行器开头 —— 见 modeGraphNativeKernel 的说明), 要么在"已核实不可等价图化"表里
// 写明缺什么能力。
//
