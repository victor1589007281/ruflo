...
var wfDetect = map[string][]string{
	...
	"creative-v2": {"做网页", "html", "做ppt", "制作ppt", "幻灯片", "演示文稿", "做视频", "生成视频", "视频创作", "动画", "宣传视频", "网站", "落地页", "landing page", "网页设计", "前端", "导出pdf", "导出png", "导出mp4", "做个页面", "生成html", "app原型", "app设计", "界面设计", "ui设计", "ux设计", "原型设计", "app prototype", "移动端设计", "手机界面", "app ui", "交互原型", "产品原型", "wireframe", "mockup"},
}
