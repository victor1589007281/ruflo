...
var wfDetect = map[string][]string{
	...
	"creative-v2": {"做网页", "html", "做ppt", "制作ppt", "幻灯片", "演示文稿", "做视频", "生成视频", "视频创作", "动画", "宣传视频", "网站", "落地页", "landing page", "网页设计", "前端", "导出pdf", "导出png", "导出mp4", "做个页面", "生成html", "app原型", "app设计", "界面设计", "ui设计", "ux设计", "原型设计", "app prototype", "移动端设计", "移动端", "手机界面", "app ui", "交互原型", "产品原型", "wireframe", "mockup", "ui界面"},
	"novel-v3":    {"写小说", "小说创作", "创作小说", "长篇小说", "短篇小说", "故事创作", "写故事", "编故事", "网文", "写网文", "连载", "科幻小说", "言情小说", "悬疑小说", "奇幻小说", "武侠小说", "小说续写", "续写", "接着写", "写下一章", "写个故事", "编个故事", "虚构创作", "fiction", "群体演化", "叙事演化", "时间线"},
}
...
- creative-v2: 做网页/HTML/做PPT/幻灯片/做视频/动画/网页设计/导出PDF/PNG/MP4/APP原型/界面设计/UI设计/产品原型/交互原型`
